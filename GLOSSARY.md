...
**Avoided Cost Calculator (ACC)** — The CPUC's official hourly model of what a unit of customer generation actually saves the grid; it sets the export credit values under the Net Billing Tariff. This report uses flat 3–8¢/kWh export credits as a bracket rather than a full ACC run, and labels that a flat-rate sensitivity. [CPUC: Avoided Cost Calculator](https://www.cpuc.ca.gov/industries-and-topics/electrical-energy/demand-side-management/energy-efficiency/idsm)
