...
**Grandfathering** — Being allowed to stay on an old, more favorable set of rules after the rules change for new customers. This home's solar is grandfathered on NEM 2.0 for about 20 years from its 2019 turn-on date — worth **$2,103.58 per year** versus the current Net Billing Tariff, re-billing the same measured year against SDG&E's real hourly export-pricing table. [CPUC: NEM and Net Billing](https://www.cpuc.ca.gov/industries-and-topics/electrical-energy/demand-side-management/customer-generation/net-energy-metering-and-net-billing)
