...
def build(N_full=5000, seed_full=43, N_legacy=5000, seed_legacy=42):
    ...
    out = {
        ...
        "escalation_two_sided_evidence_note": (
            ...
            "investigated and deferred (not built): the individually-"
            "resolved per-cell trends move together and cancel in the "
            "spread, so today's data cannot support one; guarded by "
