#!/usr/bin/env python3
"""SDGE rate plan analysis — no-CEA-relief-credit scenario (conservative).
Account: CEA generation (Clean Impact assumed), NEM 2.0, currently EV-TOU-5.
...
results=[]
for p in PLANS:
    results.append(bill(p,"CEA",relief=False))
