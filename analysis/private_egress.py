...
# bytes, FROM ONE GENERATED TABLE. The table is python's own full case folding
# -- str.casefold() -- emitted as a sed script: CASE_FOLD_SED below, and the
...
# BOTH files.
#
# THE DOMAIN IS PINNED, NOT RE-DERIVED PER RUN (issue #234). str.casefold() is
# a property of the interpreter's Unicode version, not a constant: this table is
# 1490 pairs under Unicode 13 (python 3.9), 1530 under 15 (3.12) and 1557 under
...
#     interpreter's str.casefold(), and byte-equal only when that interpreter's
...
#
# WHAT IT FOLDS, EXACTLY: every code point str.casefold() changes, to whatever
# it changes it to -- one code point for most of the table, two or three for
# the ones that fold to a sequence ('ß' to 'ss', U+0130 to 'i' plus COMBINING
# DOT ABOVE, the Latin ligatures, the Greek letters carrying an iota
# subscript). That is ASCII A-Z, the whole of the 2-byte UTF-8 range (Latin-1
# supplement, Latin Extended-A and -B, IPA, Greek and Coptic, Cyrillic,
# Armenian), the 3- and 4-byte blocks (Georgian, Cherokee, Glagolitic, Greek
# Extended, the fullwidth Latin forms, Warang Citi, Medefaidrin, Adlam,
# Deseret), and the pairs simple lowercasing leaves apart (issue #234): U+03C2
# final sigma / U+03C3 sigma, U+017F long s / 's', U+00B5 micro sign / U+03BC
# mu, U+03D0 beta symbol / beta. Cherokee folds toward the CAPITAL, as Unicode
# specifies, so those rules read the other way round from str.lower(); the
# equivalence is the same. It does NOT fold two unrelated accents: 'í' and 'å'
# are not a case pair and stay apart, and neither are U+0130 and 'i', or
# U+0131 dotless i and 'i'.
#
# WHY FULL CASE FOLDING AND NOT str.lower() (issue #234). The table this
# replaces was str.lower(), on the argument that a per-code-point substitution
# could not carry a fold that changes a name's length. It can: `s/ß/ss/g` is a
# substitution sed and this module's regex apply identically, and what the
# agreement of the two passes rests on is that no rule's output contains
# another rule's input -- which str.casefold() gives by being idempotent, and
# _check_case_fold_pairs() property 2 checks. What the str.lower() table left
# unjoined was every code point whose full casefold differs from its
# lowercase: 211 under Unicode 13 through 16, measured, of which 108 fold to
# one code point and 103 to two or three. (Issue #234 counted 297; the other
# 86 are the Cherokee capitals, which str.lower() joined from the other side.)
# On this checkout's APFS volume EVERY pair of the casefold table is one file,
# all 1557 under Unicode 16, measured by writing one spelling and stat'ing the
# other, and the four names the old residue paragraph said APFS keeps apart
# still are: 'í'/'å', U+2010/U+2030, U+0130/'i', U+0131/'i'. So the fold joins
# what the filesystem was measured to join, and the residue that erred
# fail-open is closed.
#
...
#   less than str.casefold() does.
#
# WHAT IT STILL DOES NOT FOLD, and the direction it errs:
#
...
#     entry this table exists for. FAIL-OPEN: APFS resolves the two spellings
#     to one file (measured), so a tracked-but-absent NFD entry beside an NFC
#     candidate is an alias the guard does not see.
#   * Whatever a folding volume joins that Unicode full case folding does not.
#     None was found: every table pair is one file on this checkout's APFS
#     volume and every named negative control is two. That is a measurement on
#     one volume, not a derivation, which is why it is listed.
#
# THE TABLE DOES NOT PRESERVE BYTE LENGTH, for 131 of its pairs: U+023A 'Ⱥ' ->
# U+2C65 'ⱥ' grows from two UTF-8 bytes to three, U+212A KELVIN SIGN -> 'k'
# shrinks from three to one, and every rule that folds to a sequence ('ß' ->
# 'ss') grows. Nothing in this module ever depended on that;
...
s/Y/y/g;s/Z/z/g;s/µ/μ/g;s/À/à/g;s/Á/á/g;s/Â/â/g;s/Ã/ã/g;s/Ä/ä/g
s/Å/å/g;s/Æ/æ/g;s/Ç/ç/g;s/È/è/g;s/É/é/g;s/Ê/ê/g;s/Ë/ë/g;s/Ì/ì/g
s/Í/í/g;s/Î/î/g;s/Ï/ï/g;s/Ð/ð/g;s/Ñ/ñ/g;s/Ò/ò/g;s/Ó/ó/g;s/Ô/ô/g
s/Õ/õ/g;s/Ö/ö/g;s/Ø/ø/g;s/Ù/ù/g;s/Ú/ú/g;s/Û/û/g;s/Ü/ü/g;s/Ý/ý/g
s/Þ/þ/g;s/ß/ss/g;s/Ā/ā/g;s/Ă/ă/g;s/Ą/ą/g;s/Ć/ć/g;s/Ĉ/ĉ/g;s/Ċ/ċ/g
s/Č/č/g;s/Ď/ď/g;s/Đ/đ/g;s/Ē/ē/g;s/Ĕ/ĕ/g;s/Ė/ė/g;s/Ę/ę/g;s/Ě/ě/g
s/Ĝ/ĝ/g;s/Ğ/ğ/g;s/Ġ/ġ/g;s/Ģ/ģ/g;s/Ĥ/ĥ/g;s/Ħ/ħ/g;s/Ĩ/ĩ/g;s/Ī/ī/g
s/Ĭ/ĭ/g;s/Į/į/g;s/İ/i̇/g;s/Ĳ/ĳ/g;s/Ĵ/ĵ/g;s/Ķ/ķ/g;s/Ĺ/ĺ/g;s/Ļ/ļ/g
s/Ľ/ľ/g;s/Ŀ/ŀ/g;s/Ł/ł/g;s/Ń/ń/g;s/Ņ/ņ/g;s/Ň/ň/g;s/ŉ/ʼn/g;s/Ŋ/ŋ/g
s/Ō/ō/g;s/Ŏ/ŏ/g;s/Ő/ő/g;s/Œ/œ/g;s/Ŕ/ŕ/g;s/Ŗ/ŗ/g;s/Ř/ř/g;s/Ś/ś/g
s/Ŝ/ŝ/g;s/Ş/ş/g;s/Š/š/g;s/Ţ/ţ/g;s/Ť/ť/g;s/Ŧ/ŧ/g;s/Ũ/ũ/g;s/Ū/ū/g
s/Ŭ/ŭ/g;s/Ů/ů/g;s/Ű/ű/g;s/Ų/ų/g;s/Ŵ/ŵ/g;s/Ŷ/ŷ/g;s/Ÿ/ÿ/g;s/Ź/ź/g
s/Ż/ż/g;s/Ž/ž/g;s/ſ/s/g;s/Ɓ/ɓ/g;s/Ƃ/ƃ/g;s/Ƅ/ƅ/g;s/Ɔ/ɔ/g;s/Ƈ/ƈ/g
s/Ɖ/ɖ/g;s/Ɗ/ɗ/g;s/Ƌ/ƌ/g;s/Ǝ/ǝ/g;s/Ə/ə/g;s/Ɛ/ɛ/g;s/Ƒ/ƒ/g;s/Ɠ/ɠ/g
s/Ɣ/ɣ/g;s/Ɩ/ɩ/g;s/Ɨ/ɨ/g;s/Ƙ/ƙ/g;s/Ɯ/ɯ/g;s/Ɲ/ɲ/g;s/Ɵ/ɵ/g;s/Ơ/ơ/g
s/Ƣ/ƣ/g;s/Ƥ/ƥ/g;s/Ʀ/ʀ/g;s/Ƨ/ƨ/g;s/Ʃ/ʃ/g;s/Ƭ/ƭ/g;s/Ʈ/ʈ/g;s/Ư/ư/g
s/Ʊ/ʊ/g;s/Ʋ/ʋ/g;s/Ƴ/ƴ/g;s/Ƶ/ƶ/g;s/Ʒ/ʒ/g;s/Ƹ/ƹ/g;s/Ƽ/ƽ/g;s/Ǆ/ǆ/g
s/ǅ/ǆ/g;s/Ǉ/ǉ/g;s/ǈ/ǉ/g;s/Ǌ/ǌ/g;s/ǋ/ǌ/g;s/Ǎ/ǎ/g;s/Ǐ/ǐ/g;s/Ǒ/ǒ/g
s/Ǔ/ǔ/g;s/Ǖ/ǖ/g;s/Ǘ/ǘ/g;s/Ǚ/ǚ/g;s/Ǜ/ǜ/g;s/Ǟ/ǟ/g;s/Ǡ/ǡ/g;s/Ǣ/ǣ/g
s/Ǥ/ǥ/g;s/Ǧ/ǧ/g;s/Ǩ/ǩ/g;s/Ǫ/ǫ/g;s/Ǭ/ǭ/g;s/Ǯ/ǯ/g;s/ǰ/ǰ/g;s/Ǳ/ǳ/g
s/ǲ/ǳ/g;s/Ǵ/ǵ/g;s/Ƕ/ƕ/g;s/Ƿ/ƿ/g;s/Ǹ/ǹ/g;s/Ǻ/ǻ/g;s/Ǽ/ǽ/g;s/Ǿ/ǿ/g
s/Ȁ/ȁ/g;s/Ȃ/ȃ/g;s/Ȅ/ȅ/g;s/Ȇ/ȇ/g;s/Ȉ/ȉ/g;s/Ȋ/ȋ/g;s/Ȍ/ȍ/g;s/Ȏ/ȏ/g
s/Ȑ/ȑ/g;s/Ȓ/ȓ/g;s/Ȕ/ȕ/g;s/Ȗ/ȗ/g;s/Ș/ș/g;s/Ț/ț/g;s/Ȝ/ȝ/g;s/Ȟ/ȟ/g
s/Ƞ/ƞ/g;s/Ȣ/ȣ/g;s/Ȥ/ȥ/g;s/Ȧ/ȧ/g;s/Ȩ/ȩ/g;s/Ȫ/ȫ/g;s/Ȭ/ȭ/g;s/Ȯ/ȯ/g
s/Ȱ/ȱ/g;s/Ȳ/ȳ/g;s/Ⱥ/ⱥ/g;s/Ȼ/ȼ/g;s/Ƚ/ƚ/g;s/Ⱦ/ⱦ/g;s/Ɂ/ɂ/g;s/Ƀ/ƀ/g
s/Ʉ/ʉ/g;s/Ʌ/ʌ/g;s/Ɇ/ɇ/g;s/Ɉ/ɉ/g;s/Ɋ/ɋ/g;s/Ɍ/ɍ/g;s/Ɏ/ɏ/g;s/ͅ/ι/g
s/Ͱ/ͱ/g;s/Ͳ/ͳ/g;s/Ͷ/ͷ/g;s/Ϳ/ϳ/g;s/Ά/ά/g;s/Έ/έ/g;s/Ή/ή/g;s/Ί/ί/g
s/Ჺ/ჺ/g;s/Ჽ/ჽ/g;s/Ჾ/ჾ/g;s/Ჿ/ჿ/g;s/Ḁ/ḁ/g;s/Ḃ/ḃ/g;s/Ḅ/ḅ/g;s/Ḇ/ḇ/g
s/Ḉ/ḉ/g;s/Ḋ/ḋ/g;s/Ḍ/ḍ/g;s/Ḏ/ḏ/g;s/Ḑ/ḑ/g;s/Ḓ/ḓ/g;s/Ḕ/ḕ/g;s/Ḗ/ḗ/g
s/Ḙ/ḙ/g;s/Ḛ/ḛ/g;s/Ḝ/ḝ/g;s/Ḟ/ḟ/g;s/Ḡ/ḡ/g;s/Ḣ/ḣ/g;s/Ḥ/ḥ/g;s/Ḧ/ḧ/g
s/Ḩ/ḩ/g;s/Ḫ/ḫ/g;s/Ḭ/ḭ/g;s/Ḯ/ḯ/g;s/Ḱ/ḱ/g;s/Ḳ/ḳ/g;s/Ḵ/ḵ/g;s/Ḷ/ḷ/g
s/Ḹ/ḹ/g;s/Ḻ/ḻ/g;s/Ḽ/ḽ/g;s/Ḿ/ḿ/g;s/Ṁ/ṁ/g;s/Ṃ/ṃ/g;s/Ṅ/ṅ/g;s/Ṇ/ṇ/g
s/Ṉ/ṉ/g;s/Ṋ/ṋ/g;s/Ṍ/ṍ/g;s/Ṏ/ṏ/g;s/Ṑ/ṑ/g;s/Ṓ/ṓ/g;s/Ṕ/ṕ/g;s/Ṗ/ṗ/g
s/Ṙ/ṙ/g;s/Ṛ/ṛ/g;s/Ṝ/ṝ/g;s/Ṟ/ṟ/g;s/Ṡ/ṡ/g;s/Ṣ/ṣ/g;s/Ṥ/ṥ/g;s/Ṧ/ṧ/g
s/Ṩ/ṩ/g;s/Ṫ/ṫ/g;s/Ṭ/ṭ/g;s/Ṯ/ṯ/g;s/Ṱ/ṱ/g;s/Ṳ/ṳ/g;s/Ṵ/ṵ/g;s/Ṷ/ṷ/g
s/Ṹ/ṹ/g;s/Ṻ/ṻ/g;s/Ṽ/ṽ/g;s/Ṿ/ṿ/g;s/Ẁ/ẁ/g;s/Ẃ/ẃ/g;s/Ẅ/ẅ/g;s/Ẇ/ẇ/g
s/Ẉ/ẉ/g;s/Ẋ/ẋ/g;s/Ẍ/ẍ/g;s/Ẏ/ẏ/g;s/Ẑ/ẑ/g;s/Ẓ/ẓ/g;s/Ẕ/ẕ/g;s/ẖ/ẖ/g
s/ẗ/ẗ/g;s/ẘ/ẘ/g;s/ẙ/ẙ/g;s/ẚ/aʾ/g;s/ẛ/ṡ/g;s/ẞ/ss/g;s/Ạ/ạ/g;s/Ả/ả/g
s/Ấ/ấ/g;s/Ầ/ầ/g;s/Ẩ/ẩ/g;s/Ẫ/ẫ/g;s/Ậ/ậ/g;s/Ắ/ắ/g;s/Ằ/ằ/g;s/Ẳ/ẳ/g
s/Ẵ/ẵ/g;s/Ặ/ặ/g;s/Ẹ/ẹ/g;s/Ẻ/ẻ/g;s/Ẽ/ẽ/g;s/Ế/ế/g;s/Ề/ề/g;s/Ể/ể/g
s/Ⓐ/ⓐ/g;s/Ⓑ/ⓑ/g;s/Ⓒ/ⓒ/g;s/Ⓓ/ⓓ/g;s/Ⓔ/ⓔ/g;s/Ⓕ/ⓕ/g;s/Ⓖ/ⓖ/g;s/Ⓗ/ⓗ/g
s/Ⓘ/ⓘ/g;s/Ⓙ/ⓙ/g;s/Ⓚ/ⓚ/g;s/Ⓛ/ⓛ/g;s/Ⓜ/ⓜ/g;s/Ⓝ/ⓝ/g;s/Ⓞ/ⓞ/g;s/Ⓟ/ⓟ/g
s/Ⓠ/ⓠ/g;s/Ⓡ/ⓡ/g;s/Ⓢ/ⓢ/g;s/Ⓣ/ⓣ/g;s/Ⓤ/ⓤ/g;s/Ⓥ/ⓥ/g;s/Ⓦ/ⓦ/g;s/Ⓧ/ⓧ/g
s/Ⓨ/ⓨ/g;s/Ⓩ/ⓩ/g;s/Ⰰ/ⰰ/g;s/Ⰱ/ⰱ/g;s/Ⰲ/ⰲ/g;s/Ⰳ/ⰳ/g;s/Ⰴ/ⰴ/g;s/Ⰵ/ⰵ/g
s/Ⰶ/ⰶ/g;s/Ⰷ/ⰷ/g;s/Ⰸ/ⰸ/g;s/Ⰹ/ⰹ/g;s/Ⰺ/ⰺ/g;s/Ⰻ/ⰻ/g;s/Ⰼ/ⰼ/g;s/Ⰽ/ⰽ/g
s/Ⰾ/ⰾ/g;s/Ⰿ/ⰿ/g;s/Ⱀ/ⱀ/g;s/Ⱁ/ⱁ/g;s/Ⱂ/ⱂ/g;s/Ⱃ/ⱃ/g;s/Ⱄ/ⱄ/g;s/Ⱅ/ⱅ/g
s/Ⱆ/ⱆ/g;s/Ⱇ/ⱇ/g;s/Ⱈ/ⱈ/g;s/Ⱉ/ⱉ/g;s/Ⱊ/ⱊ/g;s/Ⱋ/ⱋ/g;s/Ⱌ/ⱌ/g;s/Ⱍ/ⱍ/g
s/Ⱎ/ⱎ/g;s/Ⱏ/ⱏ/g;s/Ⱐ/ⱐ/g;s/Ⱑ/ⱑ/g;s/Ⱒ/ⱒ/g;s/Ⱓ/ⱓ/g;s/Ⱔ/ⱔ/g;s/Ⱕ/ⱕ/g
s/Ⱖ/ⱖ/g;s/Ⱗ/ⱗ/g;s/Ⱘ/ⱘ/g;s/Ⱙ/ⱙ/g;s/Ⱚ/ⱚ/g;s/Ⱛ/ⱛ/g;s/Ⱜ/ⱜ/g;s/Ⱝ/ⱝ/g
s/Ⱞ/ⱞ/g;s/Ⱟ/ⱟ/g;s/Ⱡ/ⱡ/g;s/Ɫ/ɫ/g;s/Ᵽ/ᵽ/g;s/Ɽ/ɽ/g;s/Ⱨ/ⱨ/g;s/Ⱪ/ⱪ/g
...
s/Ꞵ/ꞵ/g;s/Ꞷ/ꞷ/g;s/Ꞹ/ꞹ/g;s/Ꞻ/ꞻ/g;s/Ꞽ/ꞽ/g;s/Ꞿ/ꞿ/g;s/Ꟁ/ꟁ/g;s/Ꟃ/ꟃ/g
s/ꮻ/Ꮻ/g;s/ꮼ/Ꮼ/g;s/ꮽ/Ꮽ/g;s/ꮾ/Ꮾ/g;s/ꮿ/Ꮿ/g;s/ﬀ/ff/g;s/ﬁ/fi/g;s/ﬂ/fl/g
s/ﬃ/ffi/g;s/ﬄ/ffl/g;s/ﬅ/st/g;s/ﬆ/st/g;s/ﬓ/մն/g;s/ﬔ/մե/g;s/ﬕ/մի/g;s/ﬖ/վն/g
s/ﬗ/մխ/g;s/Ａ/ａ/g;s/Ｂ/ｂ/g;s/Ｃ/ｃ/g;s/Ｄ/ｄ/g;s/Ｅ/ｅ/g;s/Ｆ/ｆ/g;s/Ｇ/ｇ/g
s/Ｈ/ｈ/g;s/Ｉ/ｉ/g;s/Ｊ/ｊ/g;s/Ｋ/ｋ/g;s/Ｌ/ｌ/g;s/Ｍ/ｍ/g;s/Ｎ/ｎ/g;s/Ｏ/ｏ/g
s/Ｐ/ｐ/g;s/Ｑ/ｑ/g;s/Ｒ/ｒ/g;s/Ｓ/ｓ/g;s/Ｔ/ｔ/g;s/Ｕ/ｕ/g;s/Ｖ/ｖ/g;s/Ｗ/ｗ/g
s/Ｘ/ｘ/g;s/Ｙ/ｙ/g;s/Ｚ/ｚ/g;s/𐐀/𐐨/g;s/𐐁/𐐩/g;s/𐐂/𐐪/g;s/𐐃/𐐫/g;s/𐐄/𐐬/g
s/𐐅/𐐭/g;s/𐐆/𐐮/g;s/𐐇/𐐯/g;s/𐐈/𐐰/g;s/𐐉/𐐱/g;s/𐐊/𐐲/g;s/𐐋/𐐳/g;s/𐐌/𐐴/g
s/𐐍/𐐵/g;s/𐐎/𐐶/g;s/𐐏/𐐷/g;s/𐐐/𐐸/g;s/𐐑/𐐹/g;s/𐐒/𐐺/g;s/𐐓/𐐻/g;s/𐐔/𐐼/g
s/𐐕/𐐽/g;s/𐐖/𐐾/g;s/𐐗/𐐿/g;s/𐐘/𐑀/g;s/𐐙/𐑁/g;s/𐐚/𐑂/g;s/𐐛/𐑃/g;s/𐐜/𐑄/g
s/𐐝/𐑅/g;s/𐐞/𐑆/g;s/𐐟/𐑇/g;s/𐐠/𐑈/g;s/𐐡/𐑉/g;s/𐐢/𐑊/g;s/𐐣/𐑋/g;s/𐐤/𐑌/g
s/𐐥/𐑍/g;s/𐐦/𐑎/g;s/𐐧/𐑏/g;s/𐒰/𐓘/g;s/𐒱/𐓙/g;s/𐒲/𐓚/g;s/𐒳/𐓛/g;s/𐒴/𐓜/g
s/𐒵/𐓝/g;s/𐒶/𐓞/g;s/𐒷/𐓟/g;s/𐒸/𐓠/g;s/𐒹/𐓡/g;s/𐒺/𐓢/g;s/𐒻/𐓣/g;s/𐒼/𐓤/g
s/𐒽/𐓥/g;s/𐒾/𐓦/g;s/𐒿/𐓧/g;s/𐓀/𐓨/g;s/𐓁/𐓩/g;s/𐓂/𐓪/g;s/𐓃/𐓫/g;s/𐓄/𐓬/g
s/𐵛/𐵻/g;s/𐵜/𐵼/g;s/𐵝/𐵽/g;s/𐵞/𐵾/g;s/𐵟/𐵿/g;s/𐵠/𐶀/g;s/𐵡/𐶁/g;s/𐵢/𐶂/g
s/𐵣/𐶃/g;s/𐵤/𐶄/g;s/𐵥/𐶅/g;s/𑢠/𑣀/g;s/𑢡/𑣁/g;s/𑢢/𑣂/g;s/𑢣/𑣃/g;s/𑢤/𑣄/g
s/𑢥/𑣅/g;s/𑢦/𑣆/g;s/𑢧/𑣇/g;s/𑢨/𑣈/g;s/𑢩/𑣉/g;s/𑢪/𑣊/g;s/𑢫/𑣋/g;s/𑢬/𑣌/g
s/𑢭/𑣍/g;s/𑢮/𑣎/g;s/𑢯/𑣏/g;s/𑢰/𑣐/g;s/𑢱/𑣑/g;s/𑢲/𑣒/g;s/𑢳/𑣓/g;s/𑢴/𑣔/g
s/𑢵/𑣕/g;s/𑢶/𑣖/g;s/𑢷/𑣗/g;s/𑢸/𑣘/g;s/𑢹/𑣙/g;s/𑢺/𑣚/g;s/𑢻/𑣛/g;s/𑢼/𑣜/g
s/𑢽/𑣝/g;s/𑢾/𑣞/g;s/𑢿/𑣟/g;s/𖹀/𖹠/g;s/𖹁/𖹡/g;s/𖹂/𖹢/g;s/𖹃/𖹣/g;s/𖹄/𖹤/g
s/𖹅/𖹥/g;s/𖹆/𖹦/g;s/𖹇/𖹧/g;s/𖹈/𖹨/g;s/𖹉/𖹩/g;s/𖹊/𖹪/g;s/𖹋/𖹫/g;s/𖹌/𖹬/g
s/𖹍/𖹭/g;s/𖹎/𖹮/g;s/𖹏/𖹯/g;s/𖹐/𖹰/g;s/𖹑/𖹱/g;s/𖹒/𖹲/g;s/𖹓/𖹳/g;s/𖹔/𖹴/g
s/𖹕/𖹵/g;s/𖹖/𖹶/g;s/𖹗/𖹷/g;s/𖹘/𖹸/g;s/𖹙/𖹹/g;s/𖹚/𖹺/g;s/𖹛/𖹻/g;s/𖹜/𖹼/g
s/𖹝/𖹽/g;s/𖹞/𖹾/g;s/𖹟/𖹿/g;s/𞤀/𞤢/g;s/𞤁/𞤣/g;s/𞤂/𞤤/g;s/𞤃/𞤥/g;s/𞤄/𞤦/g
s/𞤅/𞤧/g;s/𞤆/𞤨/g;s/𞤇/𞤩/g;s/𞤈/𞤪/g;s/𞤉/𞤫/g;s/𞤊/𞤬/g;s/𞤋/𞤭/g;s/𞤌/𞤮/g
s/𞤍/𞤯/g;s/𞤎/𞤰/g;s/𞤏/𞤱/g;s/𞤐/𞤲/g;s/𞤑/𞤳/g;s/𞤒/𞤴/g;s/𞤓/𞤵/g;s/𞤔/𞤶/g
s/𞤕/𞤷/g;s/𞤖/𞤸/g;s/𞤗/𞤹/g;s/𞤘/𞤺/g;s/𞤙/𞤻/g;s/𞤚/𞤼/g;s/𞤛/𞤽/g;s/𞤜/𞤾/g
s/𞤝/𞤿/g;s/𞤞/𞥀/g;s/𞤟/𞥁/g;s/𞤠/𞥂/g;s/𞤡/𞥃/g
"""
...
def case_fold_pairs():
    """The (source, folded) pairs the generated table covers, taken from
    python's own str.casefold() -- the DECLARED DOMAIN, in one place.

    A pair is in exactly when str.casefold() changes the code point, and the
    target is whatever it changes it to: one code point for most, two or three
    for the ones that fold to a sequence. What that leaves out, and which way
    the omission errs, is written out above; the point of deriving it here is
    that the boundary is a two-line rule a reader can check rather than a table
    somebody typed.
    """
    out = []
...
def case_fold_sed_script(pairs=None, per_line=8):
    ...
    `s/<source>/<folded>/g`, one command per pair, packed `per_line` to a line
    with ';' separators so the block is an eighth of the rule count in lines
    rather than one line per rule. Every source and target is a cased character
    or a sequence of them, so nothing in it is a sed metacharacter (in the
    pattern or the replacement), a '/', a newline or a "'" -- which is
...
def _check_case_fold_pairs(pairs):
    ...
    agreement rests on. Cheap, and run at generation time rather than believed.
      ...
      1. no source or target carries a character that would have to be escaped
         in a sed script -- as a pattern or as a replacement, where '&' and
         '\\' are special -- a shell single-quoted string or a python string,
         and no target is empty
      2. no code point of any target is also a source, so no rule can rewrite
         another rule's output. This is what makes sed's rule-at-a-time pass
         and this module's single leftmost regex pass the same function --
         str.casefold() is idempotent, so it holds by construction, and it is
         checked because the equivalence is load-bearing rather than obvious.
         A target may be SEVERAL code points ('ß' folds to 'ss'); the property
         is about each of them
      3. every source is ONE code point, and no source is a prefix of another
         source, so no two rules compete for one position. UTF-8 lead bytes
         are never continuation bytes, which makes this true across lengths as
         well as within one
    ...
    assert all(tgt), "a case-fold pair with an empty target would delete text"
    wide = [a for a in src if len(a) != 1]
    assert not wide, f"case-fold sources that are not one code point: {wide!r}"
    clash = sorted(set(src) & set("".join(tgt)))
...
def regenerate_case_fold(root=ROOT):
    """Rewrite the marked block in BOTH files from python's own str.casefold(),
    ...
    NEVER NARROWS THE DOMAIN. str.casefold() grows with the interpreter's
    Unicode version, so regenerating on an older python than the table was
    built with would silently DELETE pairs -- aliases the guard would stop
    seeing, which is fail-open. A run under which any pair the file already
    joins would stop folding together refuses and writes nothing, naming what
    it would have lost. It is the EQUIVALENCE that is compared, not the text of
    the rule: a pair written the other way round (Cherokee folds toward the
    capital under str.casefold() and toward the small letter under str.lower())
    is the same fold, not a loss. See the domain note at CASE_FOLD_UNICODE.
    ...
    def refold(text):
        """`text` under the table about to be written. A per-character map is
        the whole function because every source is one code point and every
        target is a fixed point (_check_case_fold_pairs, properties 2 and 3)."""
        return "".join(fresh.get(ch, ch) for ch in text)
    ...
    for path, opening, closing in (
            ...
            (root / "stage-private-data.sh",
             f"# generated from python's str.casefold() under Unicode {version}\n"
             "_CASE_FOLD_SED='", "'")):
        ...
        dropped = sorted((a, b) for a, b in held if refold(a) != refold(b))
        if dropped:
            raise AssertionError(
                f"this interpreter's str.casefold() (Unicode {version}) would drop "
