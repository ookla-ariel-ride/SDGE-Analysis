...
Both Tesla configs pass `charge_pwr=5.0` (Powerwall 3's own datasheet continuous charge
rating, vs. its 11.5 kW discharge rating — see research/battery-research-notes.md); the
...
(13.5 kWh Powerwall 3 and 27 kWh PW3+Expansion, 11.5 kW discharge / 5 kW charge — Tesla's
own datasheet, issue #40, see research/battery-research-notes.md — 90% RTE): **evening-only**
...
$1,720 / $1,954 / $2,328 per year; 27 kWh $2,064 / $2,291 / $2,794; price-aware runs
...
11.5 kW: $2,792.51/yr current-behavior, $2,455.54/yr post-behavior (payback 8.31 yr) —
both cross-checked against `battery_dispatch_policies.json`'s own `pw3`/`pw3x` `greedy.save`
and `post_behavior.mid`/`high.battery_marginal` figures, within $1.54 (that canonical
...
between the two remains; $1.54 against $1,000+ savings figures is itself evidence the
